...
export function RegisterPageClient({ initialEmail }: RegisterPageClientProps) {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (registerRes.ok && registerData.next === 'otp') {
        setStep('otp');
        setMessage(registerData.message || 'A verification code has been sent to your email.');
      } else {
